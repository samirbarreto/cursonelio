...
import com.samir.curso.domain.enums.Perfil;
...
public class DBservice {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "samir.barreto@ssp.ba.gov.br", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));

		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "barreto.samir@ssp.ba.gov.br", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
